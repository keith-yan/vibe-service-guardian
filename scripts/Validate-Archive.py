    ...
    with zipfile.ZipFile(zip_path) as archive:
        ...
        if package_kind == "build-kit":
            ...
            common_required = {
                ...
                prefix + "docs/V0.8.5.1-DAILY-USE.md",
                prefix + "docs/V0.8.5.2-P1-DAILY-WORKFLOW.md",
                prefix + "docs/PRODUCTION-READINESS-0.8.5.2.md",
                prefix + "docs/case-studies/macos-vm-preview-0.8.5.2.md",
